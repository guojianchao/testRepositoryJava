...
public class EmailAction extends ActionSupport{
	...
	public String execute() throws Exception {
		System.out.println("Ö´ÐÐ³É¹¦£¡£¡"+emailInfo.getServerAddress());
...
//		emailInfo.setHtmlContents("<p class=MsoNormal style='mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'><span style='font-family:ËÎÌå;color:red'>ÄúºÃ£¡</span><span lang=EN-US style='color:red'><o:p></o:p></span></p>");
	...
	public String collectEmail(){
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if(list.get(i).getMessageId()==null||list.get(i).getMessageId().equals("")){
				listCollectEmailInfo.get(i).setMessageId("ÎÞ");
				list.get(i).setMessageId("ÎÞ");
			}
		}
	...
	public String initEmailserver(){
		...
		System.out.println(he.getHelloServicePort().getInfo("¹þ¹þ¹þ¹þ¹þ¹þ¹þ¹þ"));
