...
import com.tarena.util.MailHelper;
...
public class RegistAction extends BaseAction{
	...
	public String execute() throws Exception{
		...
		String str = "<div style='text-align:center; color:orange;'><span>图书网验证码<span><br><span>"+emailCode+"</span></div>";
		MailHelper.sendMail(user.getEmail(),str);
